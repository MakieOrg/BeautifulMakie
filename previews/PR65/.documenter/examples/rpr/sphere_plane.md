...
## background/sky color {#background/sky-color}

img = [colorant&quot;grey90&quot; for i in 1:1, j in 1:1]

## color as an array/image, hence a normal image also works {#color-as-an-array/image,-hence-a-normal-image-also-works}

lights = [EnvironmentLight(1.0, img&#39;), PointLight(Vec3f(2,0,2.0), RGBf(8.0, 6.0, 5.0))]

## custom Tesselation over an Sphere {#custom-Tesselation-over-an-Sphere}
...
## the actual figure {#the-actual-figure}
...
## save(&quot;SpherePlaneSky.png&quot;, imageOut) # save just screen scene. {#save"SpherePlaneSky.png",-imageOut-#-save-just-screen-scene.}

<img src="https://github.com/lazarusA/RPRMakieNotes/blob/main/imgs/sphere_plane_greysky.png" alt="">
