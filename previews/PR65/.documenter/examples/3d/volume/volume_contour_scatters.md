...
## volume, contour and scatters {#volume,-contour-and-scatters}
...
volume!(ax1, -1 .. 1, -1 .. 1, -1 .. 1, vol2; colormap = cmap, transparency = true)
contour!(ax2,-1 .. 1, -1 .. 1, -1 .. 1, vol1; colormap = cmap, alpha = 0.05,
...
```ansi
[33m[1m┌ [22m[39m[33m[1mWarning: [22m[39mIsorange maybe too small to resolve iso surfaces. Try `isorange > 0.0004892578125`
[33m[1m└ [22m[39m[90m@ Makie ~/.julia/packages/Makie/HyJrI/src/basic_recipes/contours.jl:183[39m
```
