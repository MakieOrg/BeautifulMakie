...
## Simple cubed mesh {#Simple-cubed-mesh}
...
## A matrix (image) as colors {#A-matrix-image-as-colors}
...
## Wrap individual colors around mesh {#Wrap-individual-colors-around-mesh}
...
## Individual images per face {#Individual-images-per-face}
