...
![](ccfsjgl.png){width=600px height=600px}
...
![](pnrxsup.png){width=600px height=400px}
...
![](vjuseoy.png){width=600px height=400px}

## 3x3 random {#3x3-random}
...
![](taqfmoq.png){width=600px height=400px}

## Tridiagonal 30x30 [-1,1] {#Tridiagonal-30x30--1,1}
...
![](nazyshg.png){width=600px height=600px}

## 8x8 random [-1, -1/f, 0, 1/f, 1] {#8x8-random--1,-1/f,-0,-1/f,-1}
...
![](pihnwup.png){width=600px height=600px}
