...
## Mandelbrot definitions {#Mandelbrot-definitions}
...
![](hcltfbw.png){width=600px height=600px}
...
![](ibfpfss.png){width=1200px height=900px}

## Julia set definitions {#Julia-set-definitions}
...
![](aehqbew.png){width=600px height=600px}

## Julia set examples {#Julia-set-examples}
...
![](imvitmb.png){width=1200px height=600px}
