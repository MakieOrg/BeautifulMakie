...
Documenter.post_status(deployconfig; type="pending", repo="github.com/lazarusA/BeautifulMakie.git")
...
deploydocs(; repo="github.com/lazarusA/BeautifulMakie.git", push_preview=true,
